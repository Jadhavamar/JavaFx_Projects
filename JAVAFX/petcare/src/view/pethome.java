...
public class pethome extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Load images
        Image dogImage = new Image("assets/Image/canva1.jpg");
        Image dogImage1 = new Image("assets/Image/pet2.jpg");
        Image dogImage2 = new Image("assets/Image/cat3.jpg");
        Image dogImage3 = new Image("assets/Image/pets3.jpg");
        Image dogImage4 = new Image("assets/Image/pet6.jpg");
        Image dogImage5 = new Image("assets/Image/pet7.jpg"); // Replace with actual image path
